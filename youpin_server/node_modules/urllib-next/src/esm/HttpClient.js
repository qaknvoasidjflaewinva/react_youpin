...
import { parseJSON, sleep, digestAuthHeader } from './utils.js';
    ...
    try {
        ...
        if (response.statusCode === 401 && response.headers['www-authenticate'] &&
            ...
            if (authenticate.startsWith('Digest ')) {
                ...
                requestOptions.headers.authorization = digestAuthHeader(requestOptions.method, requestUrl.pathname, authenticate, args.digestAuth);
